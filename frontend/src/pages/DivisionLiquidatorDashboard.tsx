    ...
    <div className="min-h-screen bg-gray-50/30">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              ...
              <p className="text-gray-600 text-sm">
                Final review and approval of district-approved liquidations across all schools
              </p>
            </div>
            <div className="flex gap-3" />
          </div>
      ...
      <div className="px-6 py-8 space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Enhanced Finalization Status Chart */}
            ...
            {/* Enhanced Finalization Timeline */}
            ...
            <CardHeader className="pb-6">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-500">
                    Schools awaiting liquidator review and approval
                  </p>
                </div>
                      ...
                      <div className="flex items-center space-x-6">
                        ...
                        <div className="flex flex-col items-center space-y-2">
                          <Badge
                            variant="solid"
                            color={
                              liquidation.status === "approved_district"
                                ? "primary"

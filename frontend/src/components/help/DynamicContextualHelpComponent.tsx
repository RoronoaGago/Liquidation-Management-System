...
const DynamicContextualHelp: React.FC<DynamicContextualHelpProps> = ({
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            {currentAction && getActionSpecificHelp() ? (
              <div className="mb-3">
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 ${className}`}>
      {isVisible && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-4 max-w-sm mb-3">
          <div className="flex items-start gap-3">

# Generated by Django 5.1.7 on 2025-07-01 10:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('approved', 'Approved'), ('rejected', 'Rejected'), ('pending', 'Pending'), ('downloaded', 'Downloaded'), ('liquidated', 'Liquidated'), ('advanced', 'Advanced')], default='pending', max_length=20)),
